...
(12, 11, 3, 2000, 2, 40, 400.0, 2000.0, 800.0, 1200.0, 15, 1);
...
(29, 'GRO2_TTT', '2020-04-23T12:00', 3, 6),
(30, 'BRA1_TTT', '2020-04-22T17:00', 3, 6);
...
insert into warehouse_manifest
(manifest_id, wh_id, ttt_id, tpa_id)
values
(10, 4, 14, 14),
(5, 5, 5, 4),
(5, 4, 8, 6),
...
(6, 5, 8, 4),
(4, 2, 10, null),
/*Test of moving manifest between TPA within same Warehouse*/
(4, 6, 29, 5),
(5, 6, 30, 6);
