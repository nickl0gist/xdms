...
VALUES
  (1, 'Świebodzice', 'PL', 'pawel@wieczorek.pl', true, 'CC Świe', '04-200', 'Lotnicza - 1', 1, 'cc_swie', 'GMT+02'),
  (2, 'Grójec', 'PL', 'sławek@barscz.pl', true, 'XD Gró', '05-600', 'Spółdzielcza - 2', 2, 'xd_gro', 'GMT+02'),
...
insert into warehouse_customer
  (wh_customerid, customerid, warehouseid, is_active,transit_time)
VALUES
  (1, 1, 1, true, 'P0DT1H0M'),
  (2, 2, 1, true, 'P0DT1H0M'),
  (3, 3, 1, false, 'P0DT1H0M'),
  (4, 4, 1, true, 'P0DT1H0M'),
  (5, 5, 1, true, 'P0DT1H0M'),
  (6, 1, 2, true, 'P0DT1H0M'),
  (7, 2, 2, true, 'P0DT1H0M'),
  (8, 3, 2, false, 'P0DT1H0M'),
  (9, 4, 2, true, 'P0DT1H0M'),
  (10, 5, 2, true, 'P0DT1H0M');
...
values ('CLOSED'),('DELAYED'),('IN_PROGRESS'),('BUFFER'),('ERROR');
